...
void SetBattleBarStruct(u8 battler, u8 healthboxSpriteId, int maxVal, int currVal, int receivedValue);
...
int MoveBattleBar(u8 battler, u8 healthboxSpriteId, u8 whichBar, u8 unused);
