...
extern const u8 gText_DuckNickname[];
...
extern const u8 gText_DuckCantBeTradedNow[];
...
extern const u8 gText_DuckCantBattle[];
...
extern const u8 gText_Stats_DuckCycles[];
extern const u8 gText_Stats_DuckCycles_VeryFast[];
extern const u8 gText_Stats_DuckCycles_Fast[];
extern const u8 gText_Stats_DuckCycles_Normal[];
extern const u8 gText_Stats_DuckCycles_Slow[];
...
extern const u8 gText_Stats_duckGroup[];
extern const u8 gText_Stats_duckGroup_Groups[];
extern const u8 gText_Stats_duckGroup_MONSTER[];
extern const u8 gText_Stats_duckGroup_WATER_1[];
extern const u8 gText_Stats_duckGroup_BUG[];
extern const u8 gText_Stats_duckGroup_FLYING[];
extern const u8 gText_Stats_duckGroup_FIELD[];
extern const u8 gText_Stats_duckGroup_FAIRY[];
extern const u8 gText_Stats_duckGroup_GRASS[];
extern const u8 gText_Stats_duckGroup_HUMAN_LIKE[];
extern const u8 gText_Stats_duckGroup_WATER_3[];
extern const u8 gText_Stats_duckGroup_MINERAL[];
extern const u8 gText_Stats_duckGroup_AMORPHOUS[];
extern const u8 gText_Stats_duckGroup_WATER_2[];
extern const u8 gText_Stats_duckGroup_DITTO[];
extern const u8 gText_Stats_duckGroup_DRAGON[];
extern const u8 gText_Stats_duckGroup_UNDISCOVERED[];
...
extern const u8 gText_DuckWillTakeALongTime[];
extern const u8 gText_DuckAboutToHatch[];
extern const u8 gText_DuckReadyToHatch_Nuzlocke[];
extern const u8 gText_DuckWillHatchSoon[];
extern const u8 gText_DuckWillTakeSomeTime[];
extern const u8 gText_PeculiarDuckNicePlace[];
extern const u8 gText_PeculiarDuckTrade[];
extern const u8 gText_DuckFromTraveler[];
extern const u8 gText_DuckFromHotSprings[];
...
extern const u8 gText_OddDuckFoundByCouple[];
...
extern const u8 gText_YouCantReleaseAnDuck[];
...
extern const u8 gText_ThatIsntAnDuck[];
extern const u8 gText_PkmnCantBeTradedNow[];
