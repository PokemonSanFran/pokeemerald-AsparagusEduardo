...
struct SaveBlock2
{
    ...
    /*0x17*/ u16 optionsSound:1; // OPTIONS_SOUND_[MONO/STEREO]
             u16 optionsMusic:1;
             u16 optionsSFX:1;
...
{
    u8 usedBoxRS:1; // Set by Pokémon Box: Ruby & Sapphire; denotes whether this save has connected to it and triggered the free False Swipe Swablu Duck giveaway.
    u8 boxRSDucksUnlocked:2; // Set by Pokémon Box: Ruby & Sapphire; denotes the number of Ducks unlocked from deposits; 1 for ExtremeSpeed Zigzagoon (at 100 deposited), 2 for Pay Day Skitty (at 500 deposited), 3 for Surf Pichu (at 1499 deposited)
    u8 padding:5;
    u8 unknownFlag1;
