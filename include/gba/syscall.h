...
void BgAffineSet(struct BgAffineSrcData *src, struct BgAffineDstData *dest, int count);

void ObjAffineSet(struct ObjAffineSrcData *src, void *dest, int count, int offset);
