...
#define SPECIES_EXDUCKCUTE 102
#define SPECIES_EXDUCKUTOR 103
...
#define SPECIES_EXDUCKUTOR_ALOLAN             FORMS_START + 67
...
#define SPECIES_DUCK SPECIES_CALYREX_SHADOW_RIDER + 1
#define NUM_SPECIES SPECIES_DUCK
