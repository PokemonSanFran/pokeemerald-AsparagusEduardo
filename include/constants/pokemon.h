...
#define EVO_ITEM_ALOLA                    39     // specified item is used on Pokémon while holding a Strange Souvenir
#define EVO_LEVEL_NIGHT_ALOLA             40     // Pokémon reaches the specified level, is night, holding Strange Souvenir
