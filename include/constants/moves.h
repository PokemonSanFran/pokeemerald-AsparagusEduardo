...
//Hidden Power
#define MOVE_HIDDEN_POWER_GROUND (MOVES_COUNT_GEN8 + 0)
#define MOVE_HIDDEN_POWER_GRASS (MOVES_COUNT_GEN8 + 1)
#define MOVE_HIDDEN_POWER_FIGHTING (MOVES_COUNT_GEN8 + 2)
#define MOVE_HIDDEN_POWER_FIRE (MOVES_COUNT_GEN8 + 3)
#define MOVE_HIDDEN_POWER_ROCK (MOVES_COUNT_GEN8 + 4)
#define MOVE_HIDDEN_POWER_ELECTRIC (MOVES_COUNT_GEN8 + 5)
#define MOVE_HIDDEN_POWER_ICE (MOVES_COUNT_GEN8 + 6)
#define MOVE_HIDDEN_POWER_WATER (MOVES_COUNT_GEN8 + 7)
#define MOVE_HIDDEN_POWER_FLYING (MOVES_COUNT_GEN8 + 8)

#define MOVES_COUNT         (MOVE_HIDDEN_POWER_FLYING + 1)
