...
#define DAYCARE_DUCK_WAITING 1
#define DAYCARE_ONE_MON     2
#define DAYCARE_TWO_MONS    3

#define INHERITED_IV_COUNT 3
#define DUCK_HATCH_LEVEL 1
#define DUCK_GENDER_MALE 0x8000  // used to create a male duck from a female-only parent species (e.g. Nidoran)
...
// Array buffers
#define DUCK_MOVES_ARRAY_COUNT           19
#define DUCK_LVL_UP_MOVES_ARRAY_COUNT    (MAX_LEVEL_UP_MOVES > 50 ? MAX_LEVEL_UP_MOVES : 50)
