...
struct ListMenuTemplate
{
    ...
    void (* moveCursorFunc)(int itemIndex, bool8 onInit, struct ListMenu *list);
...
void ListMenuDefaultCursorMoveFunc(int itemIndex, u8 onInit, struct ListMenu *list);
...
u8 AddScrollIndicatorArrowPairParameterized(u32 arrowType, int commonPos, int firstPos, int secondPos, int fullyDownThreshold, int tileTag, int palTag, u16 *currItemPtr);
