...
void BtlController_EmitMoveAnimation(u8 bufferId, u16 move, u8 turnOfMove, u16 movePower, int dmg, u8 friendship, struct DisableStruct *disableStructPtr, u8 multihit);
