...
s32 GetPokenavMenuType(void);
s32 GetPokenavCursorPos(void);
s32 GetCurrentMenuItemId(void);
...
const u8 *GetMatchCallFlavorText(s32 index, s32 textType);
...
bool32 IsRematchEntryRegistered(s32 index);
