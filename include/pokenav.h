...
void CreateRegionMapLoopedTask(int);
...
void CreateConditionGraphMenuLoopedTask(int);
...
void CreateSearchResultsLoopedTask(int);
...
void CreateRibbonsMonListLoopedTask(int);
...
void CreateRibbonsSummaryLoopedTask(int);
