...
#line 929 "include/constants/pokedex.h"
enum {
    HOENN_DEX_NONE,
    HOENN_DEX_TREECKO,
    HOENN_DEX_GROVYLE,
...
struct SaveBlock1
{
      ...
      u8 dexSeen[((((NATIONAL_DEX_ETERNATUS + 1)) / (8)) + ((((NATIONAL_DEX_ETERNATUS + 1)) % (8)) ? 1 : 0))];
      u8 dexCaught[((((NATIONAL_DEX_ETERNATUS + 1)) / (8)) + ((((NATIONAL_DEX_ETERNATUS + 1)) % (8)) ? 1 : 0))];
