...
static const u8 gSpeciesMapping[NUM_SPECIES+1] =
{
    ...
    [SPECIES_UXIE]              = EVO_TYPE_SELF,
    [SPECIES_MESPRIT]           = EVO_TYPE_SELF,
    [SPECIES_AZELF]             = EVO_TYPE_SELF,
    [SPECIES_DIALGA]            = EVO_TYPE_SELF,
    [SPECIES_PALKIA]            = EVO_TYPE_SELF,
    [SPECIES_HEATRAN]           = EVO_TYPE_SELF,
    [SPECIES_REGIGIGAS]         = EVO_TYPE_SELF,
    [SPECIES_GIRATINA]          = EVO_TYPE_SELF,
    [SPECIES_CRESSELIA]         = EVO_TYPE_SELF,
    [SPECIES_PHIONE]            = EVO_TYPE_SELF,
    [SPECIES_MANAPHY]           = EVO_TYPE_SELF,
    [SPECIES_DARKRAI]           = EVO_TYPE_SELF,
    [SPECIES_SHAYMIN]           = EVO_TYPE_SELF,
    [SPECIES_ARCEUS]            = EVO_TYPE_SELF,
    [SPECIES_VICTINI]           = EVO_TYPE_SELF,
    ...
    [SPECIES_COBALION]          = EVO_TYPE_SELF,
    [SPECIES_TERRAKION]         = EVO_TYPE_SELF,
    [SPECIES_VIRIZION]          = EVO_TYPE_SELF,
    [SPECIES_TORNADUS]          = EVO_TYPE_SELF,
    [SPECIES_THUNDURUS]         = EVO_TYPE_SELF,
    [SPECIES_RESHIRAM]          = EVO_TYPE_SELF,
    [SPECIES_ZEKROM]            = EVO_TYPE_SELF,
    [SPECIES_LANDORUS]          = EVO_TYPE_SELF,
    [SPECIES_KYUREM]            = EVO_TYPE_SELF,
    [SPECIES_KELDEO]            = EVO_TYPE_SELF,
    [SPECIES_MELOETTA]          = EVO_TYPE_SELF,
    [SPECIES_GENESECT]          = EVO_TYPE_SELF,
    ...
    [SPECIES_XERNEAS]           = EVO_TYPE_SELF,
    [SPECIES_YVELTAL]           = EVO_TYPE_SELF,
    [SPECIES_ZYGARDE]           = EVO_TYPE_SELF,
    [SPECIES_DIANCIE]           = EVO_TYPE_SELF,
    [SPECIES_HOOPA]             = EVO_TYPE_SELF,
    [SPECIES_VOLCANION]         = EVO_TYPE_SELF,
    ...
    [SPECIES_TYPE_NULL]         = EVO_TYPE_SELF,
    [SPECIES_SILVALLY]          = EVO_TYPE_SELF,
    ...
    [SPECIES_TAPU_KOKO]         = EVO_TYPE_SELF,
    [SPECIES_TAPU_LELE]         = EVO_TYPE_SELF,
    [SPECIES_TAPU_BULU]         = EVO_TYPE_SELF,
    [SPECIES_TAPU_FINI]         = EVO_TYPE_SELF,
    [SPECIES_COSMOG]            = EVO_TYPE_SELF,
    [SPECIES_COSMOEM]           = EVO_TYPE_SELF,
    [SPECIES_SOLGALEO]          = EVO_TYPE_SELF,
    [SPECIES_LUNALA]            = EVO_TYPE_SELF,
    [SPECIES_NIHILEGO]          = EVO_TYPE_SELF,
    [SPECIES_BUZZWOLE]          = EVO_TYPE_SELF,
    [SPECIES_PHEROMOSA]         = EVO_TYPE_SELF,
    [SPECIES_XURKITREE]         = EVO_TYPE_SELF,
    [SPECIES_CELESTEELA]        = EVO_TYPE_SELF,
    [SPECIES_KARTANA]           = EVO_TYPE_SELF,
    [SPECIES_GUZZLORD]          = EVO_TYPE_SELF,
    [SPECIES_NECROZMA]          = EVO_TYPE_SELF,
    [SPECIES_MAGEARNA]          = EVO_TYPE_SELF,
    [SPECIES_MARSHADOW]         = EVO_TYPE_SELF,
    [SPECIES_POIPOLE]           = EVO_TYPE_SELF,
    [SPECIES_NAGANADEL]         = EVO_TYPE_SELF,
    [SPECIES_STAKATAKA]         = EVO_TYPE_SELF,
    [SPECIES_BLACEPHALON]       = EVO_TYPE_SELF,
    [SPECIES_ZERAORA]           = EVO_TYPE_SELF,
    [SPECIES_MELTAN]            = EVO_TYPE_SELF,
    [SPECIES_MELMETAL]          = EVO_TYPE_SELF,
    ...
    [SPECIES_ZACIAN]            = EVO_TYPE_SELF,
    [SPECIES_ZAMAZENTA]         = EVO_TYPE_SELF,
    [SPECIES_ETERNATUS]         = EVO_TYPE_SELF,
    [SPECIES_KUBFU]             = EVO_TYPE_SELF,
    [SPECIES_URSHIFU]           = EVO_TYPE_SELF,
    [SPECIES_ZARUDE]            = EVO_TYPE_SELF,
    [SPECIES_REGIELEKI]         = EVO_TYPE_SELF,
    [SPECIES_REGIDRAGO]         = EVO_TYPE_SELF,
    [SPECIES_GLASTRIER]         = EVO_TYPE_SELF,
    [SPECIES_SPECTRIER]         = EVO_TYPE_SELF,
    [SPECIES_CALYREX]           = EVO_TYPE_SELF,
    ...
    [SPECIES_ARTICUNO_GALARIAN] = EVO_TYPE_SELF,
    [SPECIES_ZAPDOS_GALARIAN]   = EVO_TYPE_SELF,
    [SPECIES_MOLTRES_GALARIAN]  = EVO_TYPE_SELF,
    ...
    [SPECIES_GIRATINA_ORIGIN]   = EVO_TYPE_SELF,
    [SPECIES_SHAYMIN_SKY]       = EVO_TYPE_SELF,
    [SPECIES_ARCEUS_FIGHTING]   = EVO_TYPE_SELF,
    [SPECIES_ARCEUS_FLYING]     = EVO_TYPE_SELF,
    [SPECIES_ARCEUS_POISON]     = EVO_TYPE_SELF,
    [SPECIES_ARCEUS_GROUND]     = EVO_TYPE_SELF,
    [SPECIES_ARCEUS_ROCK]       = EVO_TYPE_SELF,
    [SPECIES_ARCEUS_BUG]        = EVO_TYPE_SELF,
    [SPECIES_ARCEUS_GHOST]      = EVO_TYPE_SELF,
    [SPECIES_ARCEUS_STEEL]      = EVO_TYPE_SELF,
    [SPECIES_ARCEUS_FIRE]       = EVO_TYPE_SELF,
    [SPECIES_ARCEUS_WATER]      = EVO_TYPE_SELF,
    [SPECIES_ARCEUS_GRASS]      = EVO_TYPE_SELF,
    [SPECIES_ARCEUS_ELECTRIC]   = EVO_TYPE_SELF,
    [SPECIES_ARCEUS_PSYCHIC]    = EVO_TYPE_SELF,
    [SPECIES_ARCEUS_ICE]        = EVO_TYPE_SELF,
    [SPECIES_ARCEUS_DRAGON]     = EVO_TYPE_SELF,
    [SPECIES_ARCEUS_DARK]       = EVO_TYPE_SELF,
    [SPECIES_ARCEUS_FAIRY]      = EVO_TYPE_SELF,
    ...
    [SPECIES_TORNADUS_THERIAN]  = EVO_TYPE_SELF,
    [SPECIES_THUNDURUS_THERIAN] = EVO_TYPE_SELF,
    [SPECIES_LANDORUS_THERIAN]  = EVO_TYPE_SELF,
    [SPECIES_KYUREM_WHITE]      = EVO_TYPE_SELF,
    [SPECIES_KYUREM_BLACK]      = EVO_TYPE_SELF,
    [SPECIES_KELDEO_RESOLUTE]   = EVO_TYPE_SELF,
    [SPECIES_MELOETTA_PIROUETTE] = EVO_TYPE_SELF,
    [SPECIES_GENESECT_DOUSE_DRIVE] = EVO_TYPE_SELF,
    [SPECIES_GENESECT_SHOCK_DRIVE] = EVO_TYPE_SELF,
    [SPECIES_GENESECT_BURN_DRIVE] = EVO_TYPE_SELF,
    [SPECIES_GENESECT_CHILL_DRIVE] = EVO_TYPE_SELF,
    ...
    [SPECIES_XERNEAS_ACTIVE]    = EVO_TYPE_SELF,
    [SPECIES_ZYGARDE_10]        = EVO_TYPE_SELF,
    [SPECIES_ZYGARDE_10_POWER_CONSTRUCT] = EVO_TYPE_SELF,
    [SPECIES_ZYGARDE_50_POWER_CONSTRUCT] = EVO_TYPE_SELF,
    [SPECIES_ZYGARDE_COMPLETE]  = EVO_TYPE_SELF,
    [SPECIES_HOOPA_UNBOUND]     = EVO_TYPE_SELF,
    ...
    [SPECIES_SILVALLY_FIGHTING] = EVO_TYPE_SELF,
    [SPECIES_SILVALLY_FLYING]   = EVO_TYPE_SELF,
    [SPECIES_SILVALLY_POISON]   = EVO_TYPE_SELF,
    [SPECIES_SILVALLY_GROUND]   = EVO_TYPE_SELF,
    [SPECIES_SILVALLY_ROCK]     = EVO_TYPE_SELF,
    [SPECIES_SILVALLY_BUG]      = EVO_TYPE_SELF,
    [SPECIES_SILVALLY_GHOST]    = EVO_TYPE_SELF,
    [SPECIES_SILVALLY_STEEL]    = EVO_TYPE_SELF,
    [SPECIES_SILVALLY_FIRE]     = EVO_TYPE_SELF,
    [SPECIES_SILVALLY_WATER]    = EVO_TYPE_SELF,
    [SPECIES_SILVALLY_GRASS]    = EVO_TYPE_SELF,
    [SPECIES_SILVALLY_ELECTRIC] = EVO_TYPE_SELF,
    [SPECIES_SILVALLY_PSYCHIC]  = EVO_TYPE_SELF,
    [SPECIES_SILVALLY_ICE]      = EVO_TYPE_SELF,
    [SPECIES_SILVALLY_DRAGON]   = EVO_TYPE_SELF,
    [SPECIES_SILVALLY_DARK]     = EVO_TYPE_SELF,
    [SPECIES_SILVALLY_FAIRY]    = EVO_TYPE_SELF,
    ...
    [SPECIES_NECROZMA_DUSK_MANE] = EVO_TYPE_SELF,
    [SPECIES_NECROZMA_DAWN_WINGS] = EVO_TYPE_SELF,
    [SPECIES_NECROZMA_ULTRA]    = EVO_TYPE_SELF,
    [SPECIES_MAGEARNA_ORIGINAL_COLOR] = EVO_TYPE_SELF,
    ...
    [SPECIES_ZACIAN_CROWNED_SWORD] = EVO_TYPE_SELF,
    [SPECIES_ZAMAZENTA_CROWNED_SHIELD] = EVO_TYPE_SELF,
    [SPECIES_ETERNATUS_ETERNAMAX] = EVO_TYPE_SELF,
    [SPECIES_URSHIFU_RAPID_STRIKE_STYLE] = EVO_TYPE_SELF,
    [SPECIES_ZARUDE_DADA]       = EVO_TYPE_SELF,
    [SPECIES_CALYREX_ICE_RIDER] = EVO_TYPE_SELF,
    [SPECIES_CALYREX_SHADOW_RIDER] = EVO_TYPE_SELF,
    #else
...
{
    u16 rnd, species, formSpeciesId, var1, var2, i, count;
