...
#if CONFIG_DECAPITALIZE_MET_LOCATION_STRINGS
const u8 gText_TrainerMemo_DuckFromDayCare[] = _("An odd Pokémon Duck found\nby {COLOR 5}{SHADOW 6}the Day Care couple{COLOR 7}{SHADOW 8}.\n\n\n“The Duck Watch”\n{DYNAMIC 2}");
const u8 gText_TrainerMemo_DuckTraded[] = _("An peculiar Pokémon Duck\nobtained in a trade.\n\n\n“The Duck Watch”\n{DYNAMIC 2}");
const u8 gText_TrainerMemo_DuckFateful[] = _("A peculiar Pokémon Duck\nobtained at {COLOR 5}{SHADOW 6}a nice place{COLOR 7}{SHADOW 8}.\n\n\n“The Duck Watch”\n{DYNAMIC 2}");
const u8 gText_TrainerMemo_DuckFatefulTraded[] = _("A peculiar Pokémon Duck\nobtained in a trade.\n\n\n“The Duck Watch”\n{DYNAMIC 2}");
const u8 gText_TrainerMemo_DuckFromHotSprings[] = _("A Pokémon Duck obtained\nat {COLOR 5}{SHADOW 6}the hot springs{COLOR 7}{SHADOW 8}.\n\n\n“The Duck Watch”\n{DYNAMIC 2}");
const u8 gText_TrainerMemo_DuckFromTraveler[] = _("An odd Pokémon Duck\nobtained from {COLOR 5}{SHADOW 6}a traveler{COLOR 7}{SHADOW 8}.\n\n\n“The Duck Watch”\n{DYNAMIC 2}");
const u8 gText_TrainerMemo_DuckFromKanto[] = _("An odd Pokémon Duck found\nby {COLOR 5}{SHADOW 6}the Day Care couple{COLOR 7}{SHADOW 8}\nin the {COLOR 5}{SHADOW 6}Kanto{COLOR 7}{SHADOW 8} region.\n\n“The Duck Watch”\n{DYNAMIC 2}");
const u8 gText_TrainerMemo_DuckFromBrigette[] = _("A Pokémon Duck obtained\nfrom {COLOR 5}{SHADOW 6}Brigette{COLOR 7}{SHADOW 8}.\n\n\n“The Duck Watch”\n{DYNAMIC 2}");
const u8 gText_TrainerMemo_BadDuck[] = _("A very mysterious\nPokémon Duck.\n\n\n“The Duck Watch”\n{DYNAMIC 2}");
