...
static const u8 sClearBodyDescription[]     = _("Evita que bajen caracterís.");
...
static const u8 sOvergrowDescription[]      = _("{UP_ARROW_2} mov. tipo Planta en apuro.");
static const u8 sBlazeDescription[]         = _("{UP_ARROW_2} mov. tipo Fuego en apuro.");
static const u8 sTorrentDescription[]       = _("{UP_ARROW_2} mov. tipo Agua en apuro.");
static const u8 sSwarmDescription[]         = _("{UP_ARROW_2} mov. tipo Bicho en apuro.");
...
static const u8 sVitalSpiritDescription[]   = _("Evita quedarse dormido.");
static const u8 sWhiteSmokeDescription[]    = _("Evita que bajen caracterís.");
static const u8 sPurePowerDescription[]     = _("Aumenta el Ataque.");
static const u8 sShellArmorDescription[]    = _("Bloquea golpes críticos.");
static const u8 sAirLockDescription[]       = _("Anula los efectos del clima.");
static const u8 sTangledFeetDescription[]   = _("{UP_ARROW_2} Evasión si está confuso.");
static const u8 sMotorDriveDescription[]    = _("{UP_ARROW_2} Velocid. con mov. Eléctr.");
static const u8 sRivalryDescription[]       = _("{UP_ARROW_2} daño a {PKMN} del mismo sexo.");
static const u8 sSteadfastDescription[]     = _("{UP_ARROW_2} Velocidad al retroceder.");
static const u8 sSnowCloakDescription[]     = _("Sube Evasión al granizar.");
static const u8 sGluttonyDescription[]      = _("Fomenta uso rápido de baya.");
static const u8 sAngerPointDescription[]    = _("Atq. Máx. con golpe crítico.");
static const u8 sUnburdenDescription[]      = _("{UP_ARROW_2} Veloc. si pierde su objeto.");
static const u8 sHeatproofDescription[]     = _("Resiste mov. de tipo Fuego.");
static const u8 sSimpleDescription[]        = _("{UP_ARROW_2} cambios en característ.");
static const u8 sDrySkinDescription[]       = _("Calor {DOWN_ARROW_2} PS, Agua {UP_ARROW_2} PS.");
static const u8 sDownloadDescription[]      = _("Fuerza diferente por rival.");
static const u8 sIronFistDescription[]      = _("Sube el daño de puñetazos.");
static const u8 sPoisonHealDescription[]    = _("Veneno hace recuperar PS.");
static const u8 sAdaptabilityDescription[]  = _("{UP_ARROW_2} daño mov. del mismo tipo.");
static const u8 sSkillLinkDescription[]     = _("{UP_ARROW_2} cant. de movim. múltiples.");
static const u8 sHydrationDescription[]     = _("Cura estado en la lluvia.");
static const u8 sSolarPowerDescription[]    = _("{DOWN_ARROW_2} PS y {UP_ARROW_2} At. Esp. con sol.");
static const u8 sQuickFeetDescription[]     = _("Sube la Velocidad si sufre.");
static const u8 sNormalizeDescription[]     = _("Movimien. son tipo Normal.");
static const u8 sSniperDescription[]        = _("{UP_ARROW_2} daño de movim. críticos.");
static const u8 sMagicGuardDescription[]    = _("Solo recibe daño directo.");
static const u8 sNoGuardDescription[]       = _("Todo movimiento acertará.");
static const u8 sStallDescription[]         = _("Será el último en moverse.");
static const u8 sTechnicianDescription[]    = _("Sube daño de movim. débiles.");
static const u8 sLeafGuardDescription[]     = _("No cambia de estado al sol.");
static const u8 sKlutzDescription[]         = _("No puede usar su objeto.");
static const u8 sMoldBreakerDescription[]   = _("Niega habilidad al usar mov.");
static const u8 sSuperLuckDescription[]     = _("{UP_ARROW_2} probabil. de golpe crítico.");
static const u8 sAftermathDescription[]     = _("Daña a quién lo debilitó.");
static const u8 sAnticipationDescription[]  = _("Prevé movimien. peligrosos.");
static const u8 sForewarnDescription[]      = _("Alerta el movim. más fuerte.");
static const u8 sUnawareDescription[]       = _("Ignora caracter. del rival.");
static const u8 sTintedLensDescription[]    = _("Aumenta daño no muy eficaz.");
static const u8 sFilterDescription[]        = _("Mitiga daño supereficaz.");
static const u8 sSlowStartDescription[]     = _("Demedie At. y Vel. iniciales.");
static const u8 sScrappyDescription[]       = _("Normal y Lucha golpea Fant.");
static const u8 sStormDrainDescription[]    = _("Niega movim. Agua, {UP_ARROW_2} At. Esp.");
static const u8 sIceBodyDescription[]       = _("Recupera PS al granizar.");
static const u8 sSnowWarningDescription[]   = _("Invoca granizo al combate.");
static const u8 sHoneyGatherDescription[]   = _("Recoge Miel de donde puede.");
static const u8 sFriskDescription[]         = _("Ve el objeto del rival.");
static const u8 sRecklessDescription[]      = _("{UP_ARROW_2} mov. que dañan al usuario.");
static const u8 sMultitypeDescription[]     = _("Cambia de tipo con Tablas.");
static const u8 sFlowerGiftDescription[]    = _("Potencia si está soleado.");
static const u8 sBadDreamsDescription[]     = _("Daña a rivales dormidos.");
static const u8 sPickpocketDescription[]    = _("Si lo golpean, roba objetos.");
static const u8 sSheerForceDescription[]    = _("Mov. sin efecto, {UP_ARROW_2} potencia.");
static const u8 sContraryDescription[]      = _("Invierte cambios caracter.");
static const u8 sUnnerveDescription[]       = _("Rival no puede comer bayas.");
static const u8 sDefiantDescription[]       = _("{UP_ARROW_2} Atq. si baja caracterís.");
static const u8 sDefeatistDescription[]     = _("1/2 PS, {DOWN_ARROW_2} características.");
static const u8 sCursedBodyDescription[]    = _("Anula mov. al ser tocado.");
static const u8 sHealerDescription[]        = _("A veces cura estado aliado.");
static const u8 sFriendGuardDescription[]   = _("Reduce daño a aliados.");
static const u8 sWeakArmorDescription[]     = _("{DOWN_ARROW_2} Def. y {UP_ARROW_2} Vel. con golpes.");
static const u8 sHeavyMetalDescription[]    = _("Duplica el peso del Pokémon.");
static const u8 sLightMetalDescription[]    = _("Demedie el peso del Pokémon.");
static const u8 sMultiscaleDescription[]    = _("{DOWN_ARROW_2} daño sufrido si PS al máx.");
static const u8 sToxicBoostDescription[]    = _("{UP_ARROW_2} Atq. si está envenenado.");
static const u8 sFlareBoostDescription[]    = _("{UP_ARROW_2} At. Esp si está Quemado.");
static const u8 sHarvestDescription[]       = _("Permite reutilizar bayas.");
static const u8 sTelepathyDescription[]     = _("Elude ataques de aliados.");
static const u8 sMoodyDescription[]         = _("{UP_ARROW_2}{UP_ARROW_2} característica, {DOWN_ARROW_2} otra.");
static const u8 sOvercoatDescription[]      = _("Niega polvo, arena y graniz.");
static const u8 sBigPecksDescription[]      = _("Defensa no puede bajar.");
static const u8 sSandRushDescription[]      = _("{UP_ARROW_2} Vel. en tormenta de arena.");
static const u8 sWonderSkinDescription[]    = _("A veces evita mov. estado.");
static const u8 sAnalyticDescription[]      = _("Si es el último, {UP_ARROW_2} daño.");
static const u8 sIllusionDescription[]      = _("Imita al último del equipo.");
static const u8 sImposterDescription[]      = _("Se transforma al entrar.");
static const u8 sInfiltratorDescription[]   = _("Ignora barreras del rival.");
static const u8 sMummyDescription[]         = _("Contagia Momia si lo tocan.");
static const u8 sMoxieDescription[]         = _("{UP_ARROW_2} Atq. al debilitar rivales.");
static const u8 sJustifiedDescription[]     = _("Mov. Sinies. lo ataca, {UP_ARROW_2} Atq.");
static const u8 sRattledDescription[]       = _("Ciertos ataques {UP_ARROW_2} Velocid.");
static const u8 sMagicBounceDescription[]   = _("Devuelve movim. de estado.");
static const u8 sSapSipperDescription[]     = _("Niega movim. Planta, {UP_ARROW_2} Atq.");
static const u8 sPranksterDescription[]     = _("Mov. estado en primer lugar.");
static const u8 sSandForceDescription[]     = _("{UP_ARROW_2} daño en torment. de arena.");
static const u8 sZenModeDescription[]       = _("Cambia de forma en un apuro.");
static const u8 sVictoryStarDescription[]   = _("{UP_ARROW_2} la Precisión del equipo.");
static const u8 sAromaVeilDescription[]     = _("Evita limitación de movim.");
static const u8 sFlowerVeilDescription[]    = _("Caract. de Planta no bajan.");
static const u8 sCheekPouchDescription[]    = _("Recupera PS al comer bayas.");
static const u8 sProteanDescription[]       = _("Cambia tipo al de ataques.");
static const u8 sFurCoatDescription[]       = _("Baja daño físico recibido.");
static const u8 sBulletproofDescription[]   = _("No le afectan proyectiles.");
static const u8 sCompetitiveDescription[]   = _("{UP_ARROW_2} At. Esp. si baja caracterí.");
static const u8 sStrongJawDescription[]     = _("Sube ataques que muerden.");
static const u8 sRefrigerateDescription[]   = _("Mov. Normal se vuelven Hielo.");
static const u8 sSweetVeilDescription[]     = _("Evita que equipo se duerma.");
static const u8 sStanceChangeDescription[]  = _("Movimient. cambian su forma");
static const u8 sGaleWingsDescription[]     = _("Prioriza movimient. Volador.");
static const u8 sMegaLauncherDescription[]  = _("{UP_ARROW_2} daño de pulsos y auras.");
static const u8 sGrassPeltDescription[]     = _("{UP_ARROW_2} Def. en Campo de Hierba.");
static const u8 sSymbiosisDescription[]     = _("Pasa su objeto a un aliado.");
static const u8 sToughClawsDescription[]    = _("{UP_ARROW_2} daño de contacto directo.");
static const u8 sPixilateDescription[]      = _("Mov. Normal se vuelven Hada.");
static const u8 sGooeyDescription[]         = _("{DOWN_ARROW_2} Veloc. de quien lo toque.");
static const u8 sAerilateDescription[]      = _("Mov. Normal se vuelve Volad.");
static const u8 sParentalBondDescription[]  = _("Golpea 2 veces por ataque.");
static const u8 sDarkAuraDescription[]      = _("{UP_ARROW_2} daño de movim. Siniestro.");
static const u8 sFairyAuraDescription[]     = _("{UP_ARROW_2} daño de movimient. Hada.");
static const u8 sAuraBreakDescription[]     = _("Invierte efectos de auras.");
static const u8 sPrimordialSeaDescription[] = _("Produce una lluvia intensa.");
static const u8 sDesolateLandDescription[]  = _("Produce un sol abrasador.");
static const u8 sDeltaStreamDescription[]   = _("Invoca fuertes vendavales.");
static const u8 sStaminaDescription[]       = _("{DOWN_ARROW_2} Defen. por golpe recibido.");
static const u8 sWimpOutDescription[]       = _("Huye si los PS menos de 1/2.");
static const u8 sWaterCompactionDescription[] = _("{UP_ARROW_2}{UP_ARROW_2} Def. por golpes Agua.");
static const u8 sMercilessDescription[]     = _("Golpe crít. a envenenados.");
static const u8 sShieldsDownDescription[]   = _("Si PS > 50%, protege estado.");
static const u8 sStakeoutDescription[]      = _("Doble daño a {PKMN} entrantes.");
static const u8 sWaterBubbleDescription[]   = _("{UP_ARROW_2} tipo Agua y {DOWN_ARROW_2} tipo Fuego.");
static const u8 sSteelworkerDescription[]   = _("{UP_ARROW_2} daño de mov. tipo Acero.");
static const u8 sBerserkDescription[]       = _("{UP_ARROW_2} At. Esp. si PS baja de 1/2.");
static const u8 sSlushRushDescription[]     = _("Duplica Velocid. en Granizo.");
static const u8 sLongReachDescription[]     = _("Sus mov. no hacen contacto.");
static const u8 sLiquidVoiceDescription[]   = _("Mov. sonoros son tipo Agua.");
static const u8 sTriageDescription[]        = _("Prioriza mov. que curan PS.");
static const u8 sGalvanizeDescription[]     = _("Mov. Normal se vuelve Eléct.");
static const u8 sSurgeSurferDescription[]   = _("Velocid. x2 en Campo Eléctr.");
static const u8 sSchoolingDescription[]     = _("Cambia forma con PS < 25%.");
static const u8 sDisguiseDescription[]      = _("Protege de un solo ataque.");
static const u8 sBattleBondDescription[]    = _("Cambia de forma al noquear.");
static const u8 sPowerConstructDescription[] = _("Cambia forma con PS < 50%.");
static const u8 sCorrosionDescription[]     = _("Puede envenenar todo tipo.");
static const u8 sComatoseDescription[]      = _("Siempre dormido pero ataca.");
static const u8 sQueenlyMajestyDescription[] = _("Anula mov. con prioridad.");
static const u8 sInnardsOutDescription[]    = _("Retorna golpe si lo noquean.");
static const u8 sDancerDescription[]        = _("Repite los movim. de danza.");
static const u8 sBatteryDescription[]       = _("{UP_ARROW_2} daño especial de aliados.");
static const u8 sFluffyDescription[]        = _("{DOWN_ARROW_2} daño contac., Fuego daña.");
static const u8 sSoulHeartDescription[]     = _("{UP_ARROW_2} At. Esp. al debilitar rival.");
static const u8 sTanglingHairDescription[]  = _("{DOWN_ARROW_2} Veloc. de quien lo toque.");
static const u8 sReceiverDescription[]      = _("Toma habil. aliado noqueado.");
static const u8 sBeastBoostDescription[]    = _("{UP_ARROW_2} Estadís. al noquear rival.");
static const u8 sRKSSystemDescription[]     = _("Cambia de tipo con Discos.");
static const u8 sElectricSurgeDescription[] = _("Produce un Campo Eléctrico.");
static const u8 sPsychicSurgeDescription[]  = _("Produce un Campo Psíquico.");
static const u8 sMistySurgeDescription[]    = _("Produce un Campo de Niebla.");
static const u8 sGrassySurgeDescription[]   = _("Produce un Campo de Hierba.");
static const u8 sFullMetalBodyDescription[] = _("Evita que bajen caracterís.");
static const u8 sNeuroforceDescription[]    = _("{UP_ARROW_2} daño supereficaz.");
static const u8 sIntrepidSwordDescription[] = _("Sube el Ataque al entrar.");
static const u8 sDauntlessShieldDescription[] = _("Sube la Defensa al entrar.");
static const u8 sLiberoDescription[]        = _("Cambia tipo al de ataques.");
static const u8 sBallFetchDescription[]     = _("Recoge Poké Balls fallidas.");
static const u8 sCottonDownDescription[]    = _("{DOWN_ARROW_2} Def. de todos con golpe.");
static const u8 sPropellerTailDescription[] = _("Ignora redirección de rival.");
static const u8 sMirrorArmorDescription[]   = _("Refleja {DOWN_ARROW_2} de característ.");
static const u8 sGulpMissileDescription[]   = _("Escupe presa si lo golpean.");
static const u8 sStalwartDescription[]      = _("Ignora redirección de rival.");
static const u8 sSteamEngineDescription[]   = _("Fuego o Agua {UP_ARROW_2} Velocidad.");
static const u8 sPunkRockDescription[]      = _("Potencia y resiste sonidos.");
static const u8 sSandSpitDescription[]      = _("Tormenta arena con golpe.");
static const u8 sIceScalesDescription[]     = _("Demedie daño especial.");
static const u8 sRipenDescription[]         = _("Duplica efectos de bayas.");
static const u8 sIceFaceDescription[]       = _("Granizo renueva bloq. daño.");
static const u8 sPowerSpotDescription[]     = _("Potencia movim. de Aliados.");
static const u8 sMimicryDescription[]       = _("Cambia su tipo al del Campo.");
static const u8 sScreenCleanerDescription[] = _("Remueve pantallas de luz.");
static const u8 sSteelySpiritDescription[]  = _("{UP_ARROW_2} daño movim. Acero aliados.");
static const u8 sPerishBodyDescription[]    = _("Tocar debilita en 3 turnos.");
static const u8 sWanderingSpiritDescription[] = _("Cambia habilidad al tocar.");
static const u8 sGorillaTacticsDescription[] = _("{UP_ARROW_2} Ataque, usa 1 movimiento.");
static const u8 sNeutralizingGasDescription[] = _("Niega todas las habilidades.");
static const u8 sPastelVeilDescription[]    = _("Protege equipo de veneno.");
...
static const u8 sUnseenFistDescription[]    = _("Contacto ignora protección.");
static const u8 sCuriousMedicineDescription[] = _("Restaura caract. de aliado.");
static const u8 sTransistorDescription[]    = _("Potencia movim. Eléctricos.");
static const u8 sDragonsMawDescription[]    = _("Potencia movimien. Dragón.");
static const u8 sChillingNeighDescription[] = _("{UP_ARROW_2} Atq. al debilitar rivales.");
static const u8 sGrimNeighDescription[]     = _("{UP_ARROW_2} At. Esp. al noquear rival.");
static const u8 sAsOneIceRiderDescription[] = _("Nerviosismo,RelincheBlanco.");
static const u8 sAsOneShadowRiderDescription[] = _("Nerviosismo, RelincheNegro.");
#else
...
const u8 gAbilityNames[ABILITIES_COUNT][ABILITY_NAME_LENGTH + 1] =
{
    ...
    [ABILITY_INTREPID_SWORD] = _("EspadIndomit"),
    ...
    [ABILITY_ICE_FACE] = _("CaraDeHielo"),
    ...
    [ABILITY_UNSEEN_FIST] = _("PuñoInvsible"),
    [ABILITY_CURIOUS_MEDICINE] = _("Med. Extraña"),
    [ABILITY_TRANSISTOR] = _("Transistor"),
    [ABILITY_DRAGONS_MAW] = _("MandibDragón"),
    [ABILITY_CHILLING_NEIGH] = _("RelinchBlanc"),
    [ABILITY_GRIM_NEIGH] = _("RelinchNegro"),
    [ABILITY_AS_ONE_ICE_RIDER] = _("UnidEcuestre"),
    [ABILITY_AS_ONE_SHADOW_RIDER] = _("UnidEcuestre"),
#else
    [ABILITY_NONE]          = _("-------"),
    [ABILITY_STENCH]        = _("Stench"),
    [ABILITY_DRIZZLE]       = _("Drizzle"),
