...
#undef CONFUSE_BERRY_HEAL_FRACTION
    ...
    [ITEM_ENIGMA_BERRY_E_READER] =
    {
        ...
        .secondaryId = BERRY_ENIGMA_E_READER,
        .flingPower = 10,
    },
