const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_PIKACHU]    = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_RAICHU},
                            {EVO_ITEM_ALOLA, ITEM_THUNDER_STONE, SPECIES_ALOLAN_RAICHU}},
    ...
    [SPECIES_KADABRA]	 = {{EVO_TRADE, 0, SPECIES_ALAKAZAM},
                            {EVO_ITEM_HOLD_DAY, ITEM_LINK_CABLE, SPECIES_ALAKAZAM},
                            {EVO_ITEM_HOLD_NIGHT, ITEM_LINK_CABLE, SPECIES_ALAKAZAM}},
    ...
    [SPECIES_MACHOKE]	 = {{EVO_TRADE, 0, SPECIES_MACHAMP},
                            {EVO_ITEM_HOLD_DAY, ITEM_LINK_CABLE, SPECIES_MACHAMP},
                            {EVO_ITEM_HOLD_NIGHT, ITEM_LINK_CABLE, SPECIES_MACHAMP}},
    ...
    [SPECIES_GRAVELER]	 = {{EVO_TRADE, 0, SPECIES_GOLEM},
                            {EVO_ITEM_HOLD_DAY, ITEM_LINK_CABLE, SPECIES_GOLEM},
                            {EVO_ITEM_HOLD_NIGHT, ITEM_LINK_CABLE, SPECIES_GOLEM}},
    ...
    [SPECIES_HAUNTER]	 = {{EVO_TRADE, 0, SPECIES_GENGAR},
                            {EVO_ITEM_HOLD_DAY, ITEM_LINK_CABLE, SPECIES_GENGAR},
                            {EVO_ITEM_HOLD_NIGHT, ITEM_LINK_CABLE, SPECIES_GENGAR}},
    ...
    [SPECIES_ONIX]       = {{EVO_TRADE_ITEM, ITEM_METAL_COAT, SPECIES_STEELIX},
                            {EVO_ITEM_HOLD_DAY, ITEM_METAL_COAT, SPECIES_STEELIX},
    ...
    [SPECIES_EXEGGCUTE]	 = {{EVO_ITEM, ITEM_LEAF_STONE, SPECIES_EXEGGUTOR},
                            {EVO_ITEM_ALOLA, ITEM_LEAF_STONE, SPECIES_ALOLAN_EXEGGUTOR}},
    ...
    [SPECIES_SEADRA]	 = {{EVO_TRADE_ITEM, ITEM_DRAGON_SCALE, SPECIES_KINGDRA},
                            {EVO_ITEM_HOLD_DAY, ITEM_DRAGON_SCALE, SPECIES_KINGDRA},
    ...
    [SPECIES_MAGMAR]	 = {{EVO_TRADE_ITEM, ITEM_MAGMARIZER, SPECIES_MAGMORTAR},
                            {EVO_ITEM_HOLD_DAY, ITEM_MAGMARIZER, SPECIES_MAGMORTAR},
    ...
    [SPECIES_PORYGON]	 = {{EVO_TRADE_ITEM, ITEM_UP_GRADE, SPECIES_PORYGON2},
                            {EVO_ITEM_HOLD_DAY, ITEM_UP_GRADE, SPECIES_PORYGON2},
    ...
    [SPECIES_PORYGON2]	 = {{EVO_TRADE_ITEM, ITEM_DUBIOUS_DISC, SPECIES_PORYGON_Z},
                            {EVO_ITEM_HOLD_DAY, ITEM_DUBIOUS_DISC, SPECIES_PORYGON_Z},
    ...
    [SPECIES_DUSCLOPS]	 = {{EVO_TRADE_ITEM, ITEM_REAPER_CLOTH, SPECIES_DUSKNOIR},
                            {EVO_ITEM_HOLD_DAY, ITEM_REAPER_CLOTH, SPECIES_DUSKNOIR},
	...
	[SPECIES_BOLDORE]	 = {{EVO_TRADE, 0, SPECIES_GIGALITH},
                            {EVO_ITEM_HOLD_DAY, ITEM_LINK_CABLE, SPECIES_GIGALITH},
                            {EVO_ITEM_HOLD_NIGHT, ITEM_LINK_CABLE, SPECIES_GIGALITH}},
	...
	[SPECIES_GURDURR]	 = {{EVO_LEVEL, 40, SPECIES_CONKELDURR},
                            {EVO_ITEM_HOLD_DAY, ITEM_LINK_CABLE, SPECIES_CONKELDURR},
                            {EVO_ITEM_HOLD_NIGHT, ITEM_LINK_CABLE, SPECIES_CONKELDURR}},
	...
	[SPECIES_PHANTUMP]	 = {{EVO_TRADE, 0, SPECIES_TREVENANT},
                            {EVO_ITEM_HOLD_DAY, ITEM_LINK_CABLE, SPECIES_TREVENANT},
                            {EVO_ITEM_HOLD_NIGHT, ITEM_LINK_CABLE, SPECIES_TREVENANT}},
	[SPECIES_PUMPKABOO]	 = {{EVO_TRADE, 0, SPECIES_GOURGEIST},
                            {EVO_ITEM_HOLD_DAY, ITEM_LINK_CABLE, SPECIES_GOURGEIST},
                            {EVO_ITEM_HOLD_NIGHT, ITEM_LINK_CABLE, SPECIES_GOURGEIST}},
    ...
    [SPECIES_ALOLAN_GRAVELER]	 = {{EVO_LEVEL, 40, SPECIES_ALOLAN_GOLEM},
                                    {EVO_ITEM_HOLD_DAY, ITEM_LINK_CABLE, SPECIES_ALOLAN_GOLEM},
                                    {EVO_ITEM_HOLD_NIGHT, ITEM_LINK_CABLE, SPECIES_ALOLAN_GOLEM}},
