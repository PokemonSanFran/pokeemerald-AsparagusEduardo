...
u16 ReadFlashId(void)
{
    ...
    readFlash1 = (u8 (*)(u8 *))((int)readFlash1Buffer + 1);
...
void SetReadFlash1(u16 *dest)
{
    ...
    PollFlashStatus = (u8 (*)(u8 *))((int)dest + 1);

    src = (u16 *)ReadFlash1;
    src = (u16 *)((int)src ^ 1);

    i = ((int)SetReadFlash1 - (int)ReadFlash1) >> 1;
...
void ReadFlash(u16 sectorNum, u32 offset, u8 *dest, u32 size)
{
    ...
    funcSrc = (vu16 *)((int)funcSrc ^ 1);
    funcDest = readFlash_Core_Buffer;

    i = ((int)ReadFlash - (int)ReadFlash_Core) >> 1;
    ...
    readFlash_Core = (void (*)(vu8 *, u8 *, u32))((int)readFlash_Core_Buffer + 1);
...
u32 VerifyFlashSector(u16 sectorNum, u8 *src)
{
    ...
    i = ((int)VerifyFlashSector - (int)VerifyFlashSector_Core) >> 1;
    ...
    verifyFlashSector_Core = (u32 (*)(u8 *, u8 *, u32))((int)verifyFlashSector_Core_Buffer + 1);
