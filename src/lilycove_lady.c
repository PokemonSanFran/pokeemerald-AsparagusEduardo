...
{
    return gSaveBlock2Ptr->lilycoveLady.id;
}
...
static void InitLilycoveFavorLady(void)
{
    sFavorLadyPtr = &gSaveBlock2Ptr->lilycoveLady.favor;
...
static void InitLilycoveQuizLady(void)
{
    ...
    sQuizLadyPtr = &gSaveBlock2Ptr->lilycoveLady.quiz;
...
u8 GetQuizAuthor(void)
{
    s32 i, j;
    u8 authorNameId;
    struct LilycoveLadyQuiz *quiz = &gSaveBlock2Ptr->lilycoveLady.quiz;
...
static void InitLilycoveContestLady(void)
{
    sContestLadyPtr = &gSaveBlock2Ptr->lilycoveLady.contest;
