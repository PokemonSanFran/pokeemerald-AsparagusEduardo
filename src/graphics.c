...
#if GAME_LANGUAGE == LANGUAGE_SPANISH
const u32 gSummaryScreen_Gfx[]                = INCBIN_U32("graphics/interface/status_screen_es.4bpp.lz");
...
const u32 gSummaryPage_Skills_Tilemap[]       = INCBIN_U32("graphics/interface/status_tilemap1_es.bin.lz");
