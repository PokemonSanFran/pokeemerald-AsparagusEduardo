 ...
 * Old/record mixed Apprentices are stored in struct Apprentice apprentices of SaveBlock1
 *   and the current Apprentice is stored in struct PlayersApprentice playerApprentice of SaveBlock1
 */
