...
void CreateEgg(struct Pokemon *mon, u16 species, bool8 setHotSpringsLocation)
{
    ...
    CreateMon(mon, species, EGG_HATCH_LEVEL, USE_RANDOM_IVS, FALSE, 0, OT_ID_PLAYER_ID, 0, 0); // handle forms
    metLevel = 0;
    ball = ITEM_POKE_BALL;
...
static void SetInitialEggData(struct Pokemon *mon, u16 species, struct DayCare *daycare)
{
    ...
    CreateMon(mon, species, EGG_HATCH_LEVEL, USE_RANDOM_IVS, TRUE, personality, OT_ID_PLAYER_ID, 0, 0); // handle forms
    metLevel = 0;
    ball = ITEM_POKE_BALL;
    language = LANGUAGE_JAPANESE;
    SetMonData(mon, MON_DATA_POKEBALL, &ball);
