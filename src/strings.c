...
const u8 gText_DuckNickname[] = _("Pato");
...
const u8 gText_FiveMarks[] = _("(?)"); // Bad duck related
...
const u8 gText_DuckCantBattle[] = _("An duck can't battle!{PAUSE_UNTIL_PRESS}");
...
ALIGNED(4) const u8 gText_DuckCantBeTradedNow[] = _("An duck can't be traded now.");
...
ALIGNED(4) const u8 gText_ThatIsntAnDuck[] = _("That isn't an duck.");
...
const u8 gText_DuckWillTakeALongTime[] = _("Parece que a este Pato le\nva a costar mucho abrirse.");
const u8 gText_DuckWillTakeSomeTime[] = _("¿Qué saldrá de éste?\nAún le queda para abrirse…");
const u8 gText_DuckWillHatchSoon[] = _("A veces se mueve.\nDebería abrirse pronto.");
const u8 gText_DuckAboutToHatch[] = _("Está haciendo ruidos.\n¡Está a punto de abrirse!");
const u8 gText_DuckReadyToHatch_Nuzlocke[] = _("Está por abrirse, pero el\n, Nuzlocke bloquea en esta ruta!");
const u8 gText_HMMovesCantBeForgotten2[] = _("HM moves can't be\nforgotten now.");
const u8 gText_XNatureMetAtYZ[] = _("Naturaleza {DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}. Visto\nen {DYNAMIC 0}{DYNAMIC 4}{DYNAMIC 1},\n{DYNAMIC 0}{DYNAMIC 5} {DYNAMIC 6}, 20{DYNAMIC 7}{DYNAMIC 1} con {LV_2} {DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1}.");
const u8 gText_XNatureHatchedAtYZ[] = _("Nat. {DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}. Eclosionado\nen {DYNAMIC 0}{DYNAMIC 4}{DYNAMIC 1},\n{DYNAMIC 0}{DYNAMIC 5} {DYNAMIC 6}, 20{DYNAMIC 7}{DYNAMIC 1} con {LV_2} {DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1}.");
const u8 gText_XNatureObtainedInTrade[] = _("Naturaleza {DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}.\nRecibido por intercambio.");
const u8 gText_XNatureFatefulEncounter[] = _("Naturaleza {DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}.\nObtenido de forma curiosa,\ncon {LV_2} {DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1}.");
const u8 gText_XNatureProbablyMetAt[] = _("Naturaleza {DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}.\nVisto, según parece, en\n{DYNAMIC 0}{DYNAMIC 4}{DYNAMIC 1} con {LV_2} {DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1}.");
const u8 gText_XNature[] = _("Naturaleza {DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}");
const u8 gText_XNatureMetSomewhereAt[] = _("Naturaleza {DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}.\nVisto en algún lugar,\ncon {LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1}.");
...
const u8 gText_Month_January[] = _("Ene.");
const u8 gText_Month_February[] = _("Feb.");
const u8 gText_Month_March[] = _("Mar.");
const u8 gText_Month_April[] = _("Abr.");
const u8 gText_Month_May[] = _("Mayo");
const u8 gText_Month_June[] = _("Jun.");
const u8 gText_Month_July[] = _("Jul.");
const u8 gText_Month_August[] = _("Ago.");
const u8 gText_Month_September[] = _("Sep.");
const u8 gText_Month_October[] = _("Oct.");
const u8 gText_Month_November[] = _("Nov.");
const u8 gText_Month_December[] = _("Dic.");
const u8 gText_OddDuckFoundByCouple[] = _("Extraño Pato hallado por\nla pareja de la Guardería.");
const u8 gText_PeculiarDuckNicePlace[] = _("Extraño Pato de Pokémon\nhallado en un lugar bonito.");
const u8 gText_PeculiarDuckTrade[] = _("A peculiar Pokémon duck\nobtained in a trade.");
const u8 gText_DuckFromHotSprings[] = _("Pato de Pokémon hallado\nen las fuentes termales.");
const u8 gText_DuckFromTraveler[] = _("Extraño Pato regalo\ndel viajante.");
...
const u8 gText_YouCantReleaseAnDuck[] = _("You can't release an Duck.");
...
const u8 gText_HatchedFromDuck[] = _("¡{STR_VAR_1} ha salido del Pato!");
...
const u8 gText_TransitionStyleInstant[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}INSTAN.");
...
const u8 gText_MoveItemWhere[] = _("¿A donde mover el objeto?");
const u8 gText_XsYAnd[] = _("{STR_VAR_1} y {STR_VAR_2} intercambiaron\n");
const u8 gText_XsYWereSwapped[] = _("sus {STR_VAR_1} y {STR_VAR_2}.{PAUSE_UNTIL_PRESS}");
...
//HGSS_Ui PokedexPlus
const u8 gText_Stats_Buttons[]  = _("{A_BUTTON}CAMBIAR  {DPAD_UPDOWN}MOVIM.");
const u8 gText_Stats_Buttons_Decapped[]  = _("{A_BUTTON}Cambiar  {DPAD_UPDOWN}Movim.");
...
const u8 gText_Stats_SpAttack[]    = _("A.SP");
const u8 gText_Stats_SpDefense[]    = _("D.SP");
...
const u8 gText_Stats_CatchRate[]     = _("CAPTURA{0x5B}: ");
const u8 gText_Stats_CatchRate_Legend[]         = _("LEGENDAR.");
const u8 gText_Stats_CatchRate_VeryHard[]       = _("MUY DIFÍC.");
const u8 gText_Stats_CatchRate_Difficult[]      = _("DIFÍCIL");
const u8 gText_Stats_CatchRate_Medium[]         = _("MEDIA");
const u8 gText_Stats_CatchRate_Relaxed[]        = _("RELAJADA");
const u8 gText_Stats_CatchRate_Easy[]           = _("FÁCIL");
const u8 gText_Stats_ExpYield[]      = _("EXPERIENCIA: ");
const u8 gText_Stats_DuckCycles[]     = _("INCUBACIÓN:");
const u8 gText_Stats_DuckCycles_VeryFast[]   = _("{EMOJI_BOLT}{EMOJI_DIZZYDUCK}");
const u8 gText_Stats_DuckCycles_Fast[]       = _("{EMOJI_DIZZYDUCK}");
const u8 gText_Stats_DuckCycles_Normal[]     = _("{EMOJI_DIZZYDUCK}{EMOJI_DIZZYDUCK}");
const u8 gText_Stats_DuckCycles_Slow[]       = _("{EMOJI_DIZZYDUCK}{EMOJI_DIZZYDUCK}{EMOJI_DIZZYDUCK}");
...
const u8 gText_Stats_MEDIUM_FAST[]   = _("MED. RAP.");
const u8 gText_Stats_ERRATIC[]       = _("ERRATICA");
const u8 gText_Stats_FLUCTUATING[]   = _("FLUCTUANDO");
const u8 gText_Stats_MEDIUM_SLOW[]   = _("MED. LEN.");
const u8 gText_Stats_FAST[]          = _("RÁPIDO");
const u8 gText_Stats_SLOW[]          = _("LENTO");
const u8 gText_Stats_ContestHeart[]  = _("H"); //Unused
const u8 gText_Stats_Minus[] = _("-");
const u8 gText_Stats_duckGroup[]             = _("DUCK G1:"); //Unused
const u8 gText_Stats_duckGroup_Groups[]      = _("{STR_VAR_1}/{STR_VAR_2}");
const u8 gText_Stats_duckGroup_MONSTER[]     = _("MONSTRUO");
const u8 gText_Stats_duckGroup_WATER_1[]     = _("AGUA {CIRCLE_1}");
const u8 gText_Stats_duckGroup_BUG[]         = _("BICHO");
const u8 gText_Stats_duckGroup_FLYING[]      = _("VOLADOR");
const u8 gText_Stats_duckGroup_FIELD[]       = _("CAMPO");
const u8 gText_Stats_duckGroup_FAIRY[]       = _("HADA");
const u8 gText_Stats_duckGroup_GRASS[]       = _("PLANTA");
const u8 gText_Stats_duckGroup_HUMAN_LIKE[]  = _("HUMANOIDE");
const u8 gText_Stats_duckGroup_WATER_3[]     = _("AGUA {CIRCLE_3}");
const u8 gText_Stats_duckGroup_MINERAL[]     = _("MINERAL");
const u8 gText_Stats_duckGroup_AMORPHOUS[]   = _("AMORFO");
const u8 gText_Stats_duckGroup_WATER_2[]     = _("AGUA {CIRCLE_2}");
const u8 gText_Stats_duckGroup_DITTO[]       = _("DITTO");
const u8 gText_Stats_duckGroup_DRAGON[]      = _("DRAGÓN");
const u8 gText_Stats_duckGroup_UNDISCOVERED[]= _("---");
...
const u8 gText_EVO_LEVEL[]                          = _("Nivel {STR_VAR_2}");
const u8 gText_EVO_TRADE[]                          = _("Intercambio");
const u8 gText_EVO_TRADE_ITEM[]                     = _("Intercambio, con {STR_VAR_2}");
const u8 gText_EVO_ITEM[]                           = _("Usar {STR_VAR_2}");
const u8 gText_EVO_LEVEL_ATK_GT_DEF[]               = _("Nivel {STR_VAR_2}, Atq > Def");
const u8 gText_EVO_LEVEL_ATK_EQ_DEF[]               = _("Nivel {STR_VAR_2}, Atq = Def");
const u8 gText_EVO_LEVEL_ATK_LT_DEF[]               = _("Nivel {STR_VAR_2}, Atq < Def");
const u8 gText_EVO_LEVEL_SILCOON[]                  = _("Nivel {STR_VAR_2}, personalid. Silcoon");
const u8 gText_EVO_LEVEL_CASCOON[]                  = _("Nivel {STR_VAR_2}, personalid. Cascoon");
const u8 gText_EVO_LEVEL_NINJASK[]                  = _("Nivel {STR_VAR_2}");
const u8 gText_EVO_LEVEL_SHEDINJA[]                 = _("Nivel {STR_VAR_2}, equipo<6, 1x Poké Ball");
const u8 gText_EVO_BEAUTY[]                         = _("Nivel, alta belleza");
const u8 gText_EVO_LEVEL_FEMALE[]                   = _("Nivel {STR_VAR_2}, hembra");
const u8 gText_EVO_LEVEL_MALE[]                     = _("Nivel {STR_VAR_2}, macho");
const u8 gText_EVO_LEVEL_NIGHT[]                    = _("Nivel {STR_VAR_2}, noche");
const u8 gText_EVO_LEVEL_DAY[]                      = _("Nivel {STR_VAR_2}, día");
const u8 gText_EVO_LEVEL_DUSK[]                     = _("Nivel {STR_VAR_2}, ocaso (5-6PM)");
const u8 gText_EVO_ITEM_HOLD_DAY[]                  = _("Nivel, con {STR_VAR_2}, día");
const u8 gText_EVO_ITEM_HOLD_NIGHT[]                = _("Nivel, con {STR_VAR_2}, noche");
const u8 gText_EVO_MOVE[]                           = _("Nivel, conoce {STR_VAR_2}");
const u8 gText_EVO_MOVE_TYPE[]                      = _("NIvel, conoce mov. {STR_VAR_2}");
const u8 gText_EVO_MAPSEC[]                         = _("Nivel en {STR_VAR_2}");
const u8 gText_EVO_ITEM_MALE[]                      = _("Usar {STR_VAR_2} en macho");
const u8 gText_EVO_ITEM_FEMALE[]                    = _("Usar {STR_VAR_2} en hembra");
const u8 gText_EVO_LEVEL_RAIN[]                     = _("Nivel {STR_VAR_2} lloviendo");
const u8 gText_EVO_SPECIFIC_MON_IN_PARTY[]          = _("Nivel con {STR_VAR_2} en equipo");
const u8 gText_EVO_LEVEL_DARK_TYPE_MON_IN_PARTY[]   = _("Nivel con tipo Sinie. en equipo");
...
const u8 gText_ExpandedPlaceholder_Brendan[] = _("Brendan");
const u8 gText_ExpandedPlaceholder_May[] = _("May");
const u8 gText_DuckNickname[] = _("Duck");
const u8 gText_Pokemon[] = _("Pokémon");
...
const u8 *const gPocketNamesStringsTable[] =
{
    ...
    [TYPEITEMS_POCKET] = gText_TypeItemsPocket,
...
const u8 gText_Info[] = _("Info");
const u8 gText_DuckWillTakeALongTime[] = _("It looks like this Duck will\ntake a long time to hatch.");
const u8 gText_DuckWillTakeSomeTime[] = _("What will hatch from this?\nIt will take some time.");
const u8 gText_DuckWillHatchSoon[] = _("It moves occasionally.\nIt should hatch soon.");
const u8 gText_DuckAboutToHatch[] = _("It's making sounds.\nIt's about to hatch!");
const u8 gText_DuckReadyToHatch_Nuzlocke[] = _("Ready to hatch, but blocked\nby Nuzlocke encounter!");
const u8 gText_HMMovesCantBeForgotten2[] = _("HM moves can't be\nforgotten now.");
const u8 gText_XNatureMetAtYZ[] = _("{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1} nature, met\nat {LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1} on {DYNAMIC 0}{DYNAMIC 5} {DYNAMIC 6}, 20{DYNAMIC 7}{DYNAMIC 1},\n{DYNAMIC 0}{DYNAMIC 4}{DYNAMIC 1}.");
const u8 gText_XNatureHatchedAtYZ[] = _("{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1} nature, hatched\nat {LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1} on {DYNAMIC 0}{DYNAMIC 5} {DYNAMIC 6}, 20{DYNAMIC 7}{DYNAMIC 1},\n{DYNAMIC 0}{DYNAMIC 4}{DYNAMIC 1}.");
...
const u8 gText_OddDuckFoundByCouple[] = _("An odd Pokémon Duck found\nby the Day Care couple.");
const u8 gText_PeculiarDuckNicePlace[] = _("A peculiar Pokémon Duck\nobtained at the nice place.");
const u8 gText_PeculiarDuckTrade[] = _("A peculiar Pokémon Duck\nobtained in a trade.");
const u8 gText_DuckFromHotSprings[] = _("A Pokémon Duck obtained\nat the hot springs.");
const u8 gText_DuckFromTraveler[] = _("An odd Pokémon Duck\nobtained from a traveler.");
const u8 gText_ApostropheSBase[] = _("'s Base");
const u8 gText_OkayToDeleteFromRegistry[] = _("Is it okay to delete {STR_VAR_1}\nfrom the registry?");
const u8 gText_RegisteredDataDeleted[] = _("The registered data was deleted.{PAUSE_UNTIL_PRESS}");
const u8 gText_NoRegistry[] = _("There is no registry.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_HatchedFromDuck[] = _("{STR_VAR_1} hatched from the Duck!");
...
const u8 gText_Stats_DuckCycles[]     = _("HATCH STEPS:");
const u8 gText_Stats_DuckCycles_VeryFast[]   = _("{EMOJI_BOLT}{EMOJI_DIZZYDUCK}");
const u8 gText_Stats_DuckCycles_Fast[]       = _("{EMOJI_DIZZYDUCK}");
const u8 gText_Stats_DuckCycles_Normal[]     = _("{EMOJI_DIZZYDUCK}{EMOJI_DIZZYDUCK}");
const u8 gText_Stats_DuckCycles_Slow[]       = _("{EMOJI_DIZZYDUCK}{EMOJI_DIZZYDUCK}{EMOJI_DIZZYDUCK}");
...
const u8 gText_Stats_duckGroup[]             = _("DUCK G1:"); //Unused
const u8 gText_Stats_duckGroup_Groups[]      = _("{STR_VAR_1}/{STR_VAR_2}");
const u8 gText_Stats_duckGroup_MONSTER[]     = _("MONSTER");
const u8 gText_Stats_duckGroup_WATER_1[]     = _("WATER {CIRCLE_1}");
const u8 gText_Stats_duckGroup_BUG[]         = _("BUG");
const u8 gText_Stats_duckGroup_FLYING[]      = _("FLYING");
const u8 gText_Stats_duckGroup_FIELD[]       = _("FIELD");
const u8 gText_Stats_duckGroup_FAIRY[]       = _("FAIRY");
const u8 gText_Stats_duckGroup_GRASS[]       = _("GRASS");
const u8 gText_Stats_duckGroup_HUMAN_LIKE[]  = _("HUMANE");
const u8 gText_Stats_duckGroup_WATER_3[]     = _("WATER {CIRCLE_3}");
const u8 gText_Stats_duckGroup_MINERAL[]     = _("MINERAL");
const u8 gText_Stats_duckGroup_AMORPHOUS[]   = _("AMORPHOUS");
const u8 gText_Stats_duckGroup_WATER_2[]     = _("WATER {CIRCLE_2}");
const u8 gText_Stats_duckGroup_DITTO[]       = _("DITTO");
const u8 gText_Stats_duckGroup_DRAGON[]      = _("DRAGON");
const u8 gText_Stats_duckGroup_UNDISCOVERED[]= _("---");
const u8 gText_Dex_SEEN[]   = _("SEEN"); //Unused
const u8 gText_Dex_OWN[]    = _("OWN"); //Unused
