...
const u8 gText_EggReadyToHatch_Nuzlocke[] = _("Está por abrirse, pero el\n, Nuzlocke bloquea en esta ruta!");
...
const u8 gText_NuzlockeFainted[] = _("¡Se debilitó en Nuzlocke!");
...
const u8 gText_Sound[] = _("Altavoces");
...
const u8 gText_TextSpeedFast[] = _("Ráp.");
...
const u8 gText_TransitionStyleInstant[] = _("INSTAN.");
const u8 gText_UnitSystemMetric[] = _("Métrico");
...
const u8 gText_AButtonDay[] = _("{A_BUTTON} Día");
const u8 gText_AButtonNight[] = _("{A_BUTTON} Noche");
...
const u8 gText_Stats_EggCycles[]     = _("INCUBACIÓN:");
...
const u8 gText_Stats_eggGroup[]             = _("EGG G1:"); //Unused
...
const u8 gText_Sound[] = _("Speakers");
