...
{
    return *moneyPtr ^ gSaveBlock1Ptr->encryptionKey;
}

void SetMoney(u32 *moneyPtr, u32 newValue)
{
    *moneyPtr = gSaveBlock1Ptr->encryptionKey ^ newValue;
}
...
{
    return IsEnoughMoney(&gSaveBlock2Ptr->money, gSpecialVar_0x8005);
}

void SubtractMoneyFromVar0x8005(void)
{
    RemoveMoney(&gSaveBlock2Ptr->money, gSpecialVar_0x8005);
}
