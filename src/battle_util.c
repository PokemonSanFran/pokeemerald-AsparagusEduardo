...
{
    [BERRY_CHERI] = {TYPE_FIRE, 80},
    [BERRY_CHESTO] = {TYPE_WATER, 80},
    [BERRY_PECHA] = {TYPE_ELECTRIC, 80},
    [BERRY_RAWST] = {TYPE_GRASS, 80},
    [BERRY_ASPEAR] = {TYPE_ICE, 80},
    [BERRY_LEPPA] = {TYPE_FIGHTING, 80},
    [BERRY_ORAN] = {TYPE_POISON, 80},
    [BERRY_PERSIM] = {TYPE_GROUND, 80},
    [BERRY_LUM] = {TYPE_FLYING, 80},
    [BERRY_SITRUS] = {TYPE_PSYCHIC, 80},
    [BERRY_FIGY] = {TYPE_BUG, 80},
    [BERRY_WIKI] = {TYPE_ROCK, 80},
    [BERRY_MAGO] = {TYPE_GHOST, 80},
    [BERRY_AGUAV] = {TYPE_DRAGON, 80},
    [BERRY_IAPAPA] = {TYPE_DARK, 80},
    [BERRY_RAZZ] = {TYPE_STEEL, 80},
    [BERRY_OCCA] = {TYPE_FIRE, 80},
    [BERRY_PASSHO] = {TYPE_WATER, 80},
    [BERRY_WACAN] = {TYPE_ELECTRIC, 80},
    [BERRY_RINDO] = {TYPE_GRASS, 80},
    [BERRY_YACHE] = {TYPE_ICE, 80},
    [BERRY_CHOPLE] = {TYPE_FIGHTING, 80},
    [BERRY_KEBIA] = {TYPE_POISON, 80},
    [BERRY_SHUCA] = {TYPE_GROUND, 80},
    [BERRY_COBA] = {TYPE_FLYING, 80},
    [BERRY_PAYAPA] = {TYPE_PSYCHIC, 80},
    [BERRY_TANGA] = {TYPE_BUG, 80},
    [BERRY_CHARTI] = {TYPE_ROCK, 80},
    [BERRY_KASIB] = {TYPE_GHOST, 80},
    [BERRY_HABAN] = {TYPE_DRAGON, 80},
    [BERRY_COLBUR] = {TYPE_DARK, 80},
    [BERRY_BABIRI] = {TYPE_STEEL, 80},
    [BERRY_CHILAN] = {TYPE_NORMAL, 80},
    [BERRY_ROSELI] = {TYPE_FAIRY, 80},
    [BERRY_BLUK] = {TYPE_FIRE, 90},
    [BERRY_NANAB] = {TYPE_WATER, 90},
    [BERRY_WEPEAR] = {TYPE_ELECTRIC, 90},
    [BERRY_PINAP] = {TYPE_GRASS, 90},
    [BERRY_POMEG] = {TYPE_ICE, 90},
    [BERRY_KELPSY] = {TYPE_FIGHTING, 90},
    [BERRY_QUALOT] = {TYPE_POISON, 90},
    [BERRY_HONDEW] = {TYPE_GROUND, 90},
    [BERRY_GREPA] = {TYPE_FLYING, 90},
    [BERRY_TAMATO] = {TYPE_PSYCHIC, 90},
    [BERRY_CORNN] = {TYPE_BUG, 90},
    [BERRY_MAGOST] = {TYPE_ROCK, 90},
    [BERRY_RABUTA] = {TYPE_GHOST, 90},
    [BERRY_NOMEL] = {TYPE_DRAGON, 90},
    [BERRY_SPELON] = {TYPE_DARK, 90},
    [BERRY_PAMTRE] = {TYPE_STEEL, 90},
    [BERRY_WATMEL] = {TYPE_FIRE, 100},
    [BERRY_DURIN] = {TYPE_WATER, 100},
    [BERRY_BELUE] = {TYPE_ELECTRIC, 100},
    [BERRY_LIECHI] = {TYPE_GRASS, 100},
    [BERRY_GANLON] = {TYPE_ICE, 100},
    [BERRY_SALAC] = {TYPE_FIGHTING, 100},
    [BERRY_PETAYA] = {TYPE_POISON, 100},
    [BERRY_APICOT] = {TYPE_GROUND, 100},
    [BERRY_LANSAT] = {TYPE_FLYING, 100},
    [BERRY_STARF] = {TYPE_PSYCHIC, 100},
    [BERRY_ENIGMA] = {TYPE_BUG, 100},
    [BERRY_MICLE] = {TYPE_ROCK, 100},
    [BERRY_CUSTAP] = {TYPE_GHOST, 100},
    [BERRY_JABOCA] = {TYPE_DRAGON, 100},
    [BERRY_ROWAP] = {TYPE_DARK, 100},
    [BERRY_KEE] = {TYPE_FAIRY, 100},
    [BERRY_MARANGA] = {TYPE_DARK, 100},
};
...
static u16 CalcMoveBasePower(u16 move, u8 battlerAtk, u8 battlerDef)
{
    ...
    case EFFECT_NATURAL_GIFT:
        basePower = gNaturalGiftTable[ItemId_GetSecondaryId(gBattleMons[battlerAtk].item)].power;
        break;
