...
{
#if I_FLAG_SYS_GBS_ENABLED != 0
    m4aSongNumStart_GBS(n, FlagGet(I_FLAG_SYS_GBS_ENABLED));
#else
    m4aSongNumStart_GBS(n, FALSE);
#endif
}
...
{
#if I_FLAG_SYS_GBS_ENABLED != 0
    m4aSongNumStartOrChange_GBS(n, FlagGet(I_FLAG_SYS_GBS_ENABLED));
#else
    m4aSongNumStartOrChange_GBS(n, FALSE);
#endif
}
...
{
#if I_FLAG_SYS_GBS_ENABLED != 0
    m4aSongNumStop_GBS(n, FlagGet(I_FLAG_SYS_GBS_ENABLED));
#else
    m4aSongNumStop_GBS(n, FALSE);
#endif
}
