...
void PlayerFaceTrainerAfterBattle(void)
{
    ...
    if (gTrainerApproachedPlayer == TRUE)
    {
        ...
        ScriptMovement_StartObjectMovementScript(OBJ_EVENT_ID_PLAYER, gSaveBlock2Ptr->location.mapNum, gSaveBlock2Ptr->location.mapGroup, gPostBattleMovementScript);
    }
    else
    {
