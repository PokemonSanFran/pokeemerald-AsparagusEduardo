...
static int MapPosToBgTilemapOffset(struct FieldCameraOffset *, int, int);
...
static void DrawMetatile(int, u16 *, u16);
...
static void DrawMetatile(int metatileLayerType, u16 *tiles, u16 offset)
{
...
static int MapPosToBgTilemapOffset(struct FieldCameraOffset *cameraOffset, int x, int y)
{
