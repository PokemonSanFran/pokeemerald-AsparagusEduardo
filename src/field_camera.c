...
{
    DrawWholeMapViewInternal(gSaveBlock2Ptr->pos.x, gSaveBlock2Ptr->pos.y, gMapHeader.mapLayout);
...
static void RedrawMapSliceNorth(struct FieldCameraOffset *cameraOffset, const struct MapLayout *mapLayout)
{
    ...
    for (i = 0; i < 32; i += 2)
    {
        ...
        if (temp >= 32)
            temp -= 32;
        DrawMetatileAt(mapLayout, r7 + temp, gSaveBlock2Ptr->pos.x + i / 2, gSaveBlock2Ptr->pos.y + 14);
    }
}
...
static void RedrawMapSliceSouth(struct FieldCameraOffset *cameraOffset, const struct MapLayout *mapLayout)
{
    ...
    for (i = 0; i < 32; i += 2)
    {
        ...
        if (temp >= 32)
            temp -= 32;
        DrawMetatileAt(mapLayout, r7 + temp, gSaveBlock2Ptr->pos.x + i / 2, gSaveBlock2Ptr->pos.y);
    }
}
...
static void RedrawMapSliceEast(struct FieldCameraOffset *cameraOffset, const struct MapLayout *mapLayout)
{
    ...
    for (i = 0; i < 32; i += 2)
    {
        ...
        if (temp >= 32)
            temp -= 32;
        DrawMetatileAt(mapLayout, temp * 32 + r6, gSaveBlock2Ptr->pos.x, gSaveBlock2Ptr->pos.y + i / 2);
    }
}
...
static void RedrawMapSliceWest(struct FieldCameraOffset *cameraOffset, const struct MapLayout *mapLayout)
{
    ...
    for (i = 0; i < 32; i += 2)
    {
        ...
        if (temp >= 32)
            temp -= 32;
        DrawMetatileAt(mapLayout, temp * 32 + r5, gSaveBlock2Ptr->pos.x + 14, gSaveBlock2Ptr->pos.y + i / 2);
    }
}
