...
static const u8 sDebugText_Flags_SwitchDexNav[] =       _("DexNav ON/OFF");
...
static const struct ListMenuItem sDebugMenu_Items_Flags[] =
{
    ...
    [DEBUG_FLAG_MENU_ITEM_DEXNAVONOFF]       = {sDebugText_Flags_SwitchDexNav,       DEBUG_FLAG_MENU_ITEM_DEXNAVONOFF},
...
static void DebugAction_Util_CheckSaveBlock(u8 taskId)
{
    static const u8 sDebugText_SaveBlockSize[] =  _("SaveBlock1 has {STR_VAR_1}/16346 bytes.\nSaveBlock2 has {STR_VAR_2}/4084 bytes.\pPokemonStorage is {STR_VAR_3} bytes long.\nMax size is 36756 bytes.");
...
{
    static const u8 sDebugText_WeekDay[] =  _("Aaaaah, yes!\l{STR_VAR_1}s are made for dads!\lAnd dad's car!$");
    RtcCalcLocalTime();
    StringCopy(gStringVar1, GetDayOfWeekString(gLocalTime.dayOfWeek));
    StringExpandPlaceholders(gStringVar4, sDebugText_WeekDay);
    Debug_DestroyMenu_Full(taskId);
    LockPlayerFieldControls();
    ScriptContext_SetupScript(Debug_ShowFieldMessageStringVar4);
    ScriptContext_Enable();
...
static void DebugAction_Flags_ToggleFlyFlags(u8 taskId)
{
    ...
    FlagToggle(FLAG_VISITED_ROUTE101);
    FlagToggle(FLAG_VISITED_ROUTE102);
    FlagToggle(FLAG_VISITED_ROUTE103);
    FlagToggle(FLAG_VISITED_ROUTE104);
    FlagToggle(FLAG_VISITED_ROUTE105);
    FlagToggle(FLAG_VISITED_ROUTE106);
    FlagToggle(FLAG_VISITED_ROUTE107);
    FlagToggle(FLAG_VISITED_ROUTE108);
    FlagToggle(FLAG_VISITED_ROUTE109);
    FlagToggle(FLAG_VISITED_ROUTE110);
    FlagToggle(FLAG_VISITED_ROUTE111);
    FlagToggle(FLAG_VISITED_ROUTE112);
    FlagToggle(FLAG_VISITED_ROUTE113);
    FlagToggle(FLAG_VISITED_ROUTE114);
    FlagToggle(FLAG_VISITED_ROUTE115);
    FlagToggle(FLAG_VISITED_ROUTE116);
    FlagToggle(FLAG_VISITED_ROUTE117);
    FlagToggle(FLAG_VISITED_ROUTE118);
    FlagToggle(FLAG_VISITED_ROUTE119);
    FlagToggle(FLAG_VISITED_ROUTE120);
    FlagToggle(FLAG_VISITED_ROUTE121);
    FlagToggle(FLAG_VISITED_ROUTE122);
    FlagToggle(FLAG_VISITED_ROUTE123);
    FlagToggle(FLAG_VISITED_ROUTE124);
    FlagToggle(FLAG_VISITED_ROUTE125);
    //FlagToggle(FLAG_VISITED_ROUTE126);
    FlagToggle(FLAG_VISITED_ROUTE127);
    FlagToggle(FLAG_VISITED_ROUTE128);
    //FlagToggle(FLAG_VISITED_ROUTE129);
    //FlagToggle(FLAG_VISITED_ROUTE130);
    //FlagToggle(FLAG_VISITED_ROUTE131);
    FlagToggle(FLAG_VISITED_ROUTE132);
    FlagToggle(FLAG_VISITED_ROUTE133);
    FlagToggle(FLAG_VISITED_ROUTE134);
    FlagToggle(FLAG_VISITED_MT_CHIMNEY);
}
static void DebugAction_Flags_ToggleBadgeFlags(u8 taskId)
{
    // Sound effect
