...
static const u8 sText_PlayerLostToEnemyTrainer[] = _("¡A {B_PLAYER_NAME} no le\nquedan Pokémon!\pPlayer perdió contra\n{B_TRAINER1_CLASS} {B_TRAINER1_NAME}!{PAUSE_UNTIL_PRESS}");
...
static const u8 sText_PlayerWhiteout2[] = _("{B_PLAYER_NAME} se desconcertó y\nse le han caído ¥{B_BUFF1}…\p… … … …\p¡{B_PLAYER_NAME} está fuera\nde combate!{PAUSE_UNTIL_PRESS}");
#else
...
static const u8 sText_LastAbilityRaisedBuff1[] = _("{B_ATK_NAME_WITH_PREFIX}'s {B_ATK_ABILITY} raised its {B_BUFF1}!");
...
static const u8 sText_MegaEvoEvolved[] = _("¡{B_ATK_NAME_WITH_PREFIX} ha evolucionado a\nMega-{B_BUFF1}!");
...
static const u8 sText_AirLockActivates[] = _("El tiempo atmosférico ya no\nejerce ninguna influencia.");
static const u8 sText_PressureActivates[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} is exerting its\npressure!");
static const u8 sText_DarkAuraActivates[] = _("¡{B_SCR_ACTIVE_NAME_WITH_PREFIX} irradia un\naura oscura!");
static const u8 sText_FairyAuraActivates[] = _("¡{B_SCR_ACTIVE_NAME_WITH_PREFIX} irradia un\naura feérica!");
...
static const u8 sText_Trainer1Fled[] = _( "{PLAY_SE SE_FLEE}{B_TRAINER1_CLASS} {B_TRAINER1_NAME} fled!"); //Unused
